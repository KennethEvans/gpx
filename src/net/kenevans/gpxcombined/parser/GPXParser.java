...
public class GPXParser {
	...
	// private static String TEST_FILE = "C:/Scratch/Oruxmaps/2014-10-18 1439__20141018_1439.gpx";
	...
	private static String GPX_COMBINED_PACKAGE = "net.kenevans.gpxcombined";
	...
	public static void save(String creator, GpxType gpx, File file) throws JAXBException {
		...
		// Create a context
		JAXBContext jc = JAXBContext.newInstance(GPX_COMBINED_PACKAGE);
		// Create a marshaller
